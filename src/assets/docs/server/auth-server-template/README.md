...
CLIENT_URL=http://localhost:4202
CLIENT_RESET_PASSWORD_URL=http://localhost:4202/reset-password
CLIENT_VERIFICATION_SUCCESS_URL=http://localhost:4202/verify-account
